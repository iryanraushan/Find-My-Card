...
public class MainFile {
    ...
    static GetAadharCard AadharCardFound = new GetAadharCard();
    static LostAadharCard AadharCardLose = new LostAadharCard();
    ...
    private static void cardList1() {
        ...
        System.out.println("3. Aadhaar Card.");
    ...
    // Function for adding details of Lost debit card.
    public static void addDetailsOfLostAadharCard() {
        ...
        String cardNumber;
        do {
            System.out.print("Enter last 12 digit of Card number : ");
            cardNumber = input.next();
        ...
        Boolean status = AadharCardFound.showStatus(nameOnCard, cardNumber);
        ...
        if (!status) {
            ...
            AadharCardLose.addLostCardList(nameOnCard, cardNumber, contactNumber);
            System.out.println("%%%~~THANK YOU FOR CHOOSING OUR SERVICES~~%%%");
        }
    }

    // Function for adding details of found debit card.
    public static void addDetailsOfGotAadharCard() {
        ...
        input.nextLine();
        Boolean status = AadharCardLose.showStatus(nameOnCard, cardNumber);
        ...
        if (!status) {
            ...
            AadharCardFound.addFoundCardList(nameOnCard, cardNumber, nameOfFounder, contactNumber);
            System.out.println("Keep the card with you. They will contact to you soon.");
            System.out.println("%%%~~THANK YOU FOR HELPING OTHERS~~%%%");
        } else {
            return;
