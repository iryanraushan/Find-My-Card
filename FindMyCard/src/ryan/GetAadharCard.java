...
public class GetAadharCard {

    AadharCardFound AadharCardFoundList;
    ...
    private class AadharCardFound extends CardFounderDetails {
        private String cardNumber;
        private String nameOnCard;
        private AadharCardFound nextCard;

        AadharCardFound(String nameOnCard, String cardNumber, String nameOfFounder, String contactNumber) {
    ...
    public void addFoundCardList(String nameOnCard, String cardNumber, String nameOfFounder, String contactNumber) {
        AadharCardFound newCard = new AadharCardFound(nameOnCard, cardNumber, nameOfFounder, contactNumber);

        if (AadharCardFoundList == null) {
            AadharCardFoundList = newCard;
            return;
        }
        AadharCardFound temp = AadharCardFoundList;
